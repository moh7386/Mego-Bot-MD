...
txt1 += `اللي ضافك مشرف: @${m.messageStubParameters[0].split`@`[0]}\n`
txt1 += `اصبحت مشرف: @${m.sender.split`@`[0]}`
...
txt2 += `الخنزير اللي شالك 🚯: @${m.messageStubParameters[0].split`@`[0]}\n`
txt2 += `لم تعد مشرف 🗿: @${m.sender.split`@`[0]}`
